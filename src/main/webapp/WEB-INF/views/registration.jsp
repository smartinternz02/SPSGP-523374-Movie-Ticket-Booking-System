                ...
                <div class="d-grid contact-addres-inf mt-5 pt-lg-4">
                    <div class="contact-info-left d-grid">
                        ...
                        <div class="contact-info">
                            ...
                            <div class="contact-details">
                                <h4>Phone:</h4>
                                <p><a href="tel:+919811763737">+91 9811763737</a></p>
                                <p><a href="tel:+918053431608">+91 8053431608</a></p>
                            </div>
                        </div>
                        <div class="contact-info">
                            <div class="icon">
                            ...
                            <div class="contact-details">
                                <h4>Mail:</h4>
                                <p><a href="mailto:mail@example.com" class="email">info@ticketbooking.com</a></p>
                                <p><a href="mailto:mail@example.com" class="email">movie@support.com</a></p>
                            </div>
                        </div>
                    </div>
                </div>
